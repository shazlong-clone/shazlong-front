      ...
      <section className="flex flex-wrap gap-5">
        {specializationList?.map((el) => {
          return (
            <button
              key={Math.random()}
              className="flex-[1_1_40%] md:flex-[1_1_30%] lg:flex-[1_1_20%] flex text-lg items-center bg-[var(--rs-bg-card)] p-5 rounded-xl gap-3 justify-center text-[var(--rs-primary-400)] cursor-pointer shadow-lg shadow-[var(--rs-gray-100)] mt-4 hover:bg-[var(--rs-gray-100)] transition"
            >
