  ...
  return (
    <main className=" lg:bg-cyan/20 bg-white  rounded-lg lg:rounded-none ">
      <div className={clsx('p-4 lg:p-10 lg:container m-auto')}>
        <h3 className="lg:text-center text-gray/80 text-[20px] lg:text-[30px] lg:mb-9">Still need help?</h3>
        <div className="lg:flex">
          <section className="lg:flex-[1_1_50%]">
            ...
            <p className="hidden lg:block lg:font-extralight mb-10">
              Contact them anytime anywhere to get the desired help, use the button below or the blue circle on the bottom right
              side.
            </p>
            <div>
