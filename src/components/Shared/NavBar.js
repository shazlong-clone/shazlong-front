      ...
      <div className="flex justify-between items-center m-auto">
        ...
        <section className="flex gap-2 items-center lg:gap-5  lg:flex-[1_1_33%]  lg:justify-end">
          ...
          <Link className="text-inherit hover:no-underline hover:text-inherit" to="/sign-in">
            <article className="text-green border border-solid border-green py-1 px-2 rounded-3xl cursor-pointer  lg:py-1 lg:px-5 text-[12px] text-center  lg:text-base">
              {t('Sign_In')}
            </article>
          </Link>
          <Link className="text-inherit hover:no-underline hover:text-inherit" to="/sign-up">
            <article className="text-white bg-green py-1 px-2 rounded-3xl cursor-pointer  lg:py-1 lg:px-5 text-[12px] text-center  lg:text-base flex rtl:pt-2">
              {t('Sign_Up')}
            </article>
          </Link>
