  ...
  return (
    <div className="bg-gray/90 text-white py-10  md:px-10 md:py-16">
          ...
          <article className="md:flex-[1_1_50%] text-sm lg:max-w-fit">
            <div className="flex max-lg:justify-between lg:gap-32">
              <section>
                ...
                <p>
                  <Link to="/">{t('Emergency_Numbers')}</Link>
                </p>
                <p>
                  <Link to="/"> {t('Privacy_And_Policy')}</Link>
                </p>
              </section>
              <section>
                <h4 className="mb-4 font-bold">{t('Resources')}</h4>
                <p>
                  <Link to="/test">{t('Psychological_Tests')}</Link>
                </p>
                <p>
      ...
      <div className="text-center mt-5">
        ...
        <a href="https://saeedkhal.github.io/saeed-khaled-portfolio/">
          {t('Saeed_Khaled')}
          <br />
        </a>
      </div>
