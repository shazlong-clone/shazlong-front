    ...
    <main className="bg-gray/5 py-3">
      <div className="container">
        ...
        <Card className="mb-5 font-[500]">
          <p>
            Our policies at Shezlong rely on transparency and aim at providing high-quality medical services, protect our clients
            and therapists from service misuse, and respect their time.
          </p>
          <p>Please take a moment to readour policy.</p>
          <p>
            By using our service you’re accepting its terms. Since September 15th, 2021, the policy outlined below has been
            effect.
          </p>
