                    ...
                    <Card className='px-0 rounded-none border border-solid border-gray/20 mt-10 lg:mt-0 lg:flex-1'>
                            ...
                            <article>
                                <hr className='my-3 lg:hidden' />
                                    <ul className='px-0 mb-0 flex gap-2 list-none'>
                                        {
                                            tabs?.map(el => {
                                                return <li key={Math.random()} onClick={()=> setActiveTabe(el?.id)} className={clsx(activeTabe === el?.id && 'border-solid border-cyan border-b-2 border-x-0 border-t-0', 'py-2 px-3 cursor-pointer font-[500]' )}>{el?.name}</li>
                                            })
                                        }
                                    </ul>
                                <hr className='my-0' />
                        ...
                        <section className='py-5 px-5'>
                            ...
                            <Card className='rounded-none border border-solid border-gray/20 mt-5'>
                                ...
                                <Link to='/therapists'>
                                    <Button appearance='primary' className='mt-3 w-full lg:w-min'>Book Your First Session</Button>
                                </Link>
                                </div>
                            </Card>
                        </section>
